...
export function BottomSheet({ open, title, onClose, children }: {
  ...
  return (
    <div className="pv-bottom-sheet fixed inset-0 z-[90] md:hidden" role="presentation">
      <button
        aria-label="Close sheet"
        className="pv-bottom-sheet-backdrop absolute inset-0 bg-black/60 backdrop-blur-sm"
        onClick={onClose}
      />
      <div
        role="dialog"
        ...
        className="pv-bottom-sheet-panel absolute inset-x-0 bottom-0 rounded-t-[2rem] border border-white/10 bg-[#151515] p-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-2xl"
      >
